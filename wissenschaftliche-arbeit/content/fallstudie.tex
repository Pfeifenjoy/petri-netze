...
\begin{tikzpicture}
    ...
    \node[place, right=6em of auftragBearbeiten, label=right:Herzustellende Grundplatte](herzustellendeGrundplatte){};
    ...
    (standbeineNachkaufen) edge[post, anchor=north] node{\textbullet}(standbeinLager)
    ...
    (herzustellendeFluegel) edge[pre, out=210, in=80, anchor=south] node{\textbullet}(fluegelHerstellen)
