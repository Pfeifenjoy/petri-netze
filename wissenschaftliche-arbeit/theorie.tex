...
\label{ssub:ablaufregeln}
	...
	\end{figure}
	\\\\
	In einer bestimmten Markierung heißt eine Transition $t$ \textbf{aktiviert}, wenn alle Plätze, aus denen $t$ Marken entnimmt, genug Marken beinhalten. Außerdem muss, wenn $t$ mit einer Formel beschriftet ist, diese gültig sein.
